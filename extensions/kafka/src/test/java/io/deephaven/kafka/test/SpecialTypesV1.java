...
public final class SpecialTypesV1 {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.deephaven.kafka.test.SpecialTypesV1.internal_static_io_deephaven_kafka_test_SpecialTypes_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return io.deephaven.kafka.test.SpecialTypesV1.internal_static_io_deephaven_kafka_test_SpecialTypes_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes.class, io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  io.deephaven.kafka.test.SpecialTypesV1.internal_static_io_deephaven_kafka_test_SpecialTypes_MpEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes)) {
        return super.equals(obj);
      }
      io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes other = (io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes) obj;
    ...
    public static io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes parseFrom(
    ...
    public static io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes parseFrom(
    ...
    public static io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes prototype) {
    ...
    public static final class Builder extends
        ...
        io.deephaven.kafka.test.SpecialTypesV1.SpecialTypesOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return io.deephaven.kafka.test.SpecialTypesV1.internal_static_io_deephaven_kafka_test_SpecialTypes_descriptor;
      }
      ...
      @java.lang.Override
      public io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes getDefaultInstanceForType() {
        return io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes.getDefaultInstance();
      }

      @java.lang.Override
      public io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes build() {
        io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes result = buildPartial();
      ...
      @java.lang.Override
      public io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes buildPartial() {
        io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes result = new io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes) {
          return mergeFrom((io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes)other);
        } else {
      ...
      public Builder mergeFrom(io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes other) {
        if (other == io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes.getDefaultInstance()) return this;
        if (other.hasTs()) {
          mergeTs(other.getTs());
        }
    ...
    private static final io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes();
    }

    public static io.deephaven.kafka.test.SpecialTypesV1.SpecialTypes getDefaultInstance() {
