...
public class ParquetTableResolverPropertyConfig implements ParquetTableResolver.Config {
    ...
    public static final String PARQUET_TABLE_RESOLVER_ENABLED_KEY = "deephaven.uri-router.ParquetTableResolver.enabled";
    ...
    public ParquetTableResolverPropertyConfig() {
        final String expected = UriRouterPropertyConfig.propertyKey(ParquetTableResolver.class);
