...
public class WhereFilterTest extends TestCase {
    ...
    public void testFilterTrue() {
        assertThat(WhereFilter.of(DUMMY_DEF, Filter.ofTrue())).isEqualTo(WhereAllFilter.INSTANCE);
    }

    public void testFilterFalse() {
        assertThat(WhereFilter.of(DUMMY_DEF, Filter.ofFalse())).isEqualTo(WhereNoneFilter.INSTANCE);
    }

    private static void expect(Filter filter, Class<? extends WhereFilter> clazz, String expected) {
        WhereFilter impl = WhereFilter.of(DUMMY_DEF, filter);
