...
// ****** Edit CharArrayChunkEquals and run "./gradlew replicateHashing" to regenerate
//
// @formatter:off
...
// region name
public class ByteArrayChunkEquals implements ChunkEquals {
    public static final ByteArrayChunkEquals INSTANCE = new ByteArrayChunkEquals();
    // endregion name

    public static boolean equalReduce(ObjectChunk<byte[], ? extends Any> lhs, ObjectChunk<byte[], ? extends Any> rhs) {
    ...
    public static int firstDifference(ObjectChunk<byte[], ? extends Any> lhs, ObjectChunk<byte[], ? extends Any> rhs) {
        int ii = 0;
    ...
    private static void equal(ObjectChunk<byte[], ? extends Any> lhs, ObjectChunk<byte[], ? extends Any> rhs,
    ...
    private static void equalNext(ObjectChunk<byte[], ? extends Any> chunk, WritableBooleanChunk destination) {
    ...
    private static void equal(ObjectChunk<byte[], ? extends Any> lhs, byte[] rhs, WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    public static void notEqual(ObjectChunk<byte[], ? extends Any> lhs, ObjectChunk<byte[], ? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    public static void notEqual(ObjectChunk<byte[], ? extends Any> lhs, byte[] rhs, WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void andEqual(ObjectChunk<byte[], ? extends Any> lhs, ObjectChunk<byte[], ? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void andNotEqual(ObjectChunk<byte[], ? extends Any> lhs, ObjectChunk<byte[], ? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void andEqualNext(ObjectChunk<byte[], ? extends Any> chunk, WritableBooleanChunk destination) {
        for (int ii = 0; ii < chunk.size() - 1; ++ii) {
    ...
    private static void equalPairs(IntChunk<ChunkPositions> chunkPositionsToCheckForEquality,
            ObjectChunk<byte[], ? extends Any> valuesChunk, WritableBooleanChunk destinations) {
    ...
    private static void equalPermuted(IntChunk<ChunkPositions> lhsPositions, IntChunk<ChunkPositions> rhsPositions,
            ObjectChunk<byte[], ? extends Any> lhs, ObjectChunk<byte[], ? extends Any> rhs,
    ...
    private static void equalLhsPermuted(IntChunk<ChunkPositions> lhsPositions, ObjectChunk<byte[], ? extends Any> lhs,
            ObjectChunk<byte[], ? extends Any> rhs, WritableBooleanChunk destinations) {
        for (int ii = 0; ii < lhsPositions.size(); ++ii) {
            final int lhsPosition = lhsPositions.get(ii);
