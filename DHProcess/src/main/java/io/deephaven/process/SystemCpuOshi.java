...
public abstract class SystemCpuOshi implements PropertySet {
     ...
     * which is the Processor signature, represented in human-readable form by
     * {@link ProcessorIdentifier#getIdentifier()} . The remaining four bytes are the contents of the EDX register,
     * containing feature flags.
     *
