...
public class GenerateLargeArray {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final File file = new File("/tmp/test.string-long-ts-nanos.json");
        ...
        try (final JsonGenerator generator = factory.createGenerator(file, JsonEncoding.UTF8)) {
            ...
            for (int i = 0; i < length; ++i) {
                // generator.writeNumber(Math.random());
                generator.writeString(Long.toString(start.plusSeconds(i).toEpochMilli() * 1_000_000 + start.getNano()));
            }
