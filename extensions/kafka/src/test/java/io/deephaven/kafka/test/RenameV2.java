...
public final class RenameV2 {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.deephaven.kafka.test.RenameV2.internal_static_io_deephaven_kafka_test_Rename_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return io.deephaven.kafka.test.RenameV2.internal_static_io_deephaven_kafka_test_Rename_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              io.deephaven.kafka.test.RenameV2.Rename.class, io.deephaven.kafka.test.RenameV2.Rename.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof io.deephaven.kafka.test.RenameV2.Rename)) {
        return super.equals(obj);
      }
      io.deephaven.kafka.test.RenameV2.Rename other = (io.deephaven.kafka.test.RenameV2.Rename) obj;
    ...
    public static io.deephaven.kafka.test.RenameV2.Rename parseFrom(
    ...
    public static io.deephaven.kafka.test.RenameV2.Rename parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static io.deephaven.kafka.test.RenameV2.Rename parseFrom(
    ...
    public static io.deephaven.kafka.test.RenameV2.Rename parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static io.deephaven.kafka.test.RenameV2.Rename parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static io.deephaven.kafka.test.RenameV2.Rename parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(io.deephaven.kafka.test.RenameV2.Rename prototype) {
    ...
    public static final class Builder extends
        ...
        io.deephaven.kafka.test.RenameV2.RenameOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return io.deephaven.kafka.test.RenameV2.internal_static_io_deephaven_kafka_test_Rename_descriptor;
      }
      ...
      @java.lang.Override
      public io.deephaven.kafka.test.RenameV2.Rename getDefaultInstanceForType() {
        return io.deephaven.kafka.test.RenameV2.Rename.getDefaultInstance();
      }

      @java.lang.Override
      public io.deephaven.kafka.test.RenameV2.Rename build() {
        io.deephaven.kafka.test.RenameV2.Rename result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof io.deephaven.kafka.test.RenameV2.Rename) {
          return mergeFrom((io.deephaven.kafka.test.RenameV2.Rename)other);
        } else {
      ...
      public Builder mergeFrom(io.deephaven.kafka.test.RenameV2.Rename other) {
        if (other == io.deephaven.kafka.test.RenameV2.Rename.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final io.deephaven.kafka.test.RenameV2.Rename DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new io.deephaven.kafka.test.RenameV2.Rename();
    }

    public static io.deephaven.kafka.test.RenameV2.Rename getDefaultInstance() {
