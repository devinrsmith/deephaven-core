...
public final class GcApplication implements ApplicationState.Factory, NotificationListener {
    ...
    /**
     * Looks up the system property "io.deephaven.GcApplication.enabled", defaults to {@code false}.
     *
    ...
    /**
     * Looks up the system property "io.deephaven.GcApplication.notification_info.enabled", defaults to {@code true}.
     *
     * @return if notification_info is enabled
     */
    ...
    /**
     * Looks up the system property "io.deephaven.GcApplication.notification_info_stats.enabled", defaults to
     * {@code true}.
     *
     * @return if notification_info_stats is enabled
     */
    ...
    /**
     * Looks up the system property "io.deephaven.GcApplication.notification_info_ring.size", defaults to {@code 1024}.
     * The notification_info_ring table is disable if when {@code 0} or less.
     *
     * @return the notification_info_ring size
     */
    ...
    /**
     * Looks up the system property "io.deephaven.GcApplication.pools.enabled", defaults to {@code true}.
     *
     * @return if pools is enabled
     */
    ...
    /**
     * Looks up the system property "io.deephaven.GcApplication.pools_stats.enabled", defaults to {@code true}.
     *
     * @return if pools_stats is enabled
     */
