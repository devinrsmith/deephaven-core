...
public abstract class SettableBits64 {
    ...
    public static SettableBits64 create(BitBuilder builder) {
        return ImmutableSettableBits64.builder().s0(SettableBits16.create(builder))
            .s16(SettableBits16.create(builder)).s32(SettableBits16.create(builder))
            .s48(SettableBits16.create(builder)).build();
    }
    ...
    public final Bits64 toBits() {
        return ImmutableBits64.builder().b0(s0().toBits()).b16(s16().toBits()).b32(s32().toBits())
            .b48(s48().toBits()).build();
    }
}
